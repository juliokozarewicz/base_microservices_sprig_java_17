package com.juliokozarewicz.documentation.e_controller;

import com.juliokozarewicz.documentation.c_validation.HelloWorldValidation;
import com.juliokozarewicz.documentation.d_services.HelloWorldService;
...
class HelloWorldController {
    ...
    @GetMapping("${BASE_URL_DOCUMENTATION:default}/documentation")
